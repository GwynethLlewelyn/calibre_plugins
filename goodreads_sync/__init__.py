...
class ActionGoodreadsSync(InterfaceActionBase):
    ...
    def config_widget(self):
        ...
        if self.actual_plugin_:
            ...
            if grhttp is not None:
                return ConfigWidget(self.actual_plugin_, grhttp)
            else:
                return (
                    "Goodreads Sync failed to configure HttpHelper module",
                    "Please ask help from an experienced user",
                )
        else:
            return (
                "Goodreads Sync couldn't configure itself",
                "Please ask help from an experienced user",
            )
